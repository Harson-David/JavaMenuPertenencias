 ...
 */
public class InstructorEdit extends javax.swing.JFrame {
    ...
    public InstructorEdit(int userId) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InstructorEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            InstructorEdit userinstructorEdit = new InstructorEdit(LoginEntradaUsers.userId);
