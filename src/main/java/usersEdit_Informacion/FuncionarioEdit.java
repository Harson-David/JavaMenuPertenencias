 ...
 */
public class FuncionarioEdit extends javax.swing.JFrame {
    ...
    public FuncionarioEdit(int userId) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FuncionarioEdit userAdminEdit = new FuncionarioEdit(LoginEntradaUsers.userId);
